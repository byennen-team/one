Template.widgetSearch.events({
  // clear search input when X is clicked
  'click .search-clear': function (event) {
...
// The following is pasted from /one-search/search_client.js, as a jumpstarter:
...
// /END paste from /one-search/search_client.js