...
(function(window, document, navigator, undefined){
    ...
    var getSelectionRect = function()
    {
        if( window.getSelection )
        {
            ...
            if( range.getBoundingClientRect ) // Missing for Firefox 3.5+3.6
            {
                ...
                // Safari 5.1 returns null, IE9 returns
                // 0/0/0/0 if image selected
            ...
            /*
            // Fall back to inserting a temporary
            // element (only for Firefox 3.5 and 3.6)
    ...
    */
    ...
    window.wysiwyg = function( option )
    {
        ...
        if( option_onselection )
        {
            handleSelection = function( clientX, clientY, rightclick )
            {
                ...
                if( rect )
                {
                    ...
                    {
                        // Make it relative to the editor
        ...
        {
            // debounce 'syncTextarea' a second time,
            // because 'innerHTML' is quite burdensome
